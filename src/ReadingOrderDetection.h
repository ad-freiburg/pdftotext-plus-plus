...
#ifndef READINGORDERDETECTION_H_
#define READINGORDERDETECTION_H_
...
class ReadingOrderDetection {
 public:
   ...
   * @param config
   *   The configuration to use for detecting the reading order.
   * @param config
   *   The configuration to use for predicting semantic roles.
   */
