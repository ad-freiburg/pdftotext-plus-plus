...
// _________________________________________________________________________________________________
SemanticRolesPrediction::~SemanticRolesPrediction() {
  if (_modelOk) {
    delete _model;
  }
}
...
// _________________________________________________________________________________________________
void SemanticRolesPrediction::readModel() {
//   // Read the model.
...
// _________________________________________________________________________________________________
void SemanticRolesPrediction::predict(const PdfDocument* doc) {
  assert(doc);
...
// _________________________________________________________________________________________________
cppflow::tensor SemanticRolesPrediction::createLayoutInputTensor(const PdfDocument* doc) {
  assert(doc);
...
// _________________________________________________________________________________________________
cppflow::tensor SemanticRolesPrediction::createWordsInputTensor(const PdfDocument* doc) {
  assert(doc);
