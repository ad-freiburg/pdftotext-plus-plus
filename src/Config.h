...
// static double DEFAULT_H_DPI = 72.0;
// static double DEFAULT_V_DPI = 72.0;
...
//   // TODO(korzen): Documentation.
//   double hDPI = DEFAULT_H_DPI;
//   double vDPI = DEFAULT_V_DPI;

//   // -----------------------------------------------------------------------------------------------

//   // The config to use while parsing a PDF file.
//   struct {
//     // The log level.
//     LogLevel logLevel = ERROR;
...
//     double fsPrec = DEFAULT_FONT_SIZE_PREC;
...
//     double coordsEqualTolerance = DEFAULT_COORDS_EQUAL_TOLERANCE;
//   } pdfParsing;

//   // -----------------------------------------------------------------------------------------------

//   // The config to use while calculating statistics.
//   struct {
//     // The log level.
//     LogLevel logLevel = ERROR;
...
//     double fsEqualTolerance = DEFAULT_FS_EQUAL_TOLERANCE;
...
//     double sameLineYOverlapRatioThreshold = 0.5;
...
//     double otherLineYOverlapRatioThreshold = 0;
...
//     // before computing the most frequent line distance.
//     double lineDistPrec = DEFAULT_LINE_DIST_PREC;
//   } statisticsCalculation;

//   // -----------------------------------------------------------------------------------------------

//   // The config to use while merging diacritical marks.
//   struct {
//     // The log level.
//     LogLevel logLevel = ERROR;
...
//   // The config to use while detecting words.
//   struct {
//     // The log level.
//     LogLevel logLevel = ERROR;
...
//     double yOverlapRatioThreshold = 0.5;
...
//      *    The threshold.
//      */
//     constexpr static double getHorizontalGapThreshold(const PdfDocument* doc,
//         const PdfWord* activeWord) {
...
//     // The third set contains *words* that are likely to be a base word of a stacked math symbol.
//     unordered_set<string> stackedMathCharTexts = { "∑", "∏", "∫", "⊗" };
//     unordered_set<string> stackedMathCharNames = { "summationdisplay",
...
//     // denotes the minimum x-overlap ratio between a word w and the base word of the stacked math
//     // symbol, so that w is considered to be a part of the stacked math symbol.
//     double stackedMathSymbolXOverlapRatioThreshold = 0.5;
//   } wordsDetection;

//   // -----------------------------------------------------------------------------------------------

//   // The config to use while segmenting pages.
//   struct {
//     // The log level.
//     LogLevel logLevel = ERROR;
...
//   // The config to use while detecting text lines.
//   struct {
//     // The log level.
//     LogLevel logLevel = ERROR;
...
//   // The config to use while detecting sub- and superscripts.
//   struct {
//     // The log level.
//     LogLevel logLevel = ERROR;
...
//     // character "sit" on the same baseline. If the baseline of a character is larger than the
//     // baseline of the text line (under consideration of the threshold), the character is
//     // considered to be a superscript. If the baseline is smaller, the character is considered to
//     // be a subscript.
//     double baseEqualTolerance = 0.1;

//     // A parameter that is used to detect sub- and superscripts. It denotes the maximum allowed
//     // difference between the font size of a character and the most frequent font size in the
//     // document, so that the font sizes are considered to be equal. If the font size of a character
//     // is smaller than the most frequent font size (under consideration of the threshold), the
//     // character is considered to be a sub- or superscript. Otherwise, it is not considered to be a
//     // sub-/superscript.
//     double fsEqualTolerance = 0.9;
//   } scriptsDetection;
...
//   // The config to use while detecting text blocks.
//   struct {
//     // The log level.
//     LogLevel logLevel = ERROR;
...
//     // considered equal. If the font size of a text line is larger than the font size of the
//     // previous line by this threshold, it is assumed that the text line introduces a new text
//     // block.
//     double fsEqualTolerance = 1.0;
...
//   // The config to use while predicting the semantic roles of text blocks.
//   struct {
//     // The path to the directory containing the (serialized) learning model.
//     string modelsDir;
//   } rolesPrediction;
...
//   //  ----------------------------------------------------------------------------------------------
  ...
  // The config to use while creating the visualization for a PDF file.
  struct {
    // The log level.
    LogLevel logLevel = ERROR;
